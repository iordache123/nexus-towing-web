...
export default function Pricing() {
  return (
    <section id="preturi" className="scroll-mt-24 py-24 bg-zinc-950">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Transparență Tarifară</h2>
            <p className="text-zinc-400 max-w-xl">Prețuri corecte, fără costuri ascunse. Costul final se calculează transparent la telefon, pe baza distanței și a tipului de autovehicul.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 hover:border-zinc-600 transition-colors">
          ...
          <div className="bg-gradient-to-b from-zinc-800 to-zinc-900 border border-amber-500/50 rounded-3xl p-8 relative shadow-[0_0_40px_-15px_rgba(245,158,11,0.3)] transform md:-translate-y-4">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-amber-500 text-zinc-900 font-bold px-4 py-1 rounded-full text-sm">
              Cel mai solicitat
            </div>
            ...
            <div className="flex items-baseline gap-2 mb-6">
              ...
              <span className="text-zinc-400">RON + km</span>
            </div>
            <ul className="space-y-4 mb-8 text-zinc-300">
