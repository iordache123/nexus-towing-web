      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-slate-400 hover:text-amber-500 transition-colors">Tractare Auto</a></li>
              <li><a href="#" className="text-slate-400 hover:text-amber-500 transition-colors">Platformă SUV & Dubițe</a></li>
              <li><a href="#" className="text-slate-400 hover:text-amber-500 transition-colors">Asistență Pană / Baterie</a></li>
              <li><a href="#" className="text-slate-400 hover:text-amber-500 transition-colors">Extragere din Șanț</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-sm text-slate-500">
            ...
            <a href="#" className="hover:text-white transition-colors">Politică Cookies</a>
          </div>
        </div>
      </div>
    </footer>
